...
public: 
	size_t operator()(const std::pair< Stop*, Stop*> pair_stops) const
	{
		...
		//return first_hash_lat * 2 + first_hash_lng * 3 + second_hash_lat + second_hash_lng * 5;
		//return first_hash_lat * 2 + second_hash_lat;
		return coor_hasher(pair_stops.first) + coor_hasher(pair_stops.second) * 37;
	}
