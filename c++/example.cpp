...
struct Document {
    ...
    double relevance;
    int rating;
    Document(int id_default = 0,
    double relevance_default = 0,
    int rating_default = 0)
    :id(id_default), relevance(relevance_default), rating(rating_default)    
    {}
};
